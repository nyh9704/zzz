...
$.AdminLTE.change_skin = function(cls, obj) {

    $.each($.AdminLTE.skins, function(i) {
        $("body").removeClass($.AdminLTE.skins[i]);
    });
...
var tmp = get('skin');
if (tmp && $.inArray(tmp, $.AdminLTE.skins)) {
    $.AdminLTE.change_skin(tmp);
    $(".cs_" + tmp).addClass("active");
};
