...
import com.wyzc.htgl.dao.NegotiateRecordDao;

@Service
public class NegotiateRecordService {
    @Autowired
    private NegotiateRecordDao nrd;
    ...
    public Map<String, Object> searchnegotiateRecord(ClientInfoBo bo) {
        ...
        bo.setUserId(userId);
        //查询当前登录用户的姓名
        String userName = this.nrd.searchUserName(bo);
        ...
        if (bo.getTodayVisit().equals("1")) {
            ...
            list = this.nrd.searchnegotiateRecord(page);
