...
public class ChannelHousePo2 extends BasePo {
    private String channelCode;//编号
    private String channelNature;//性质
    private String channelNature1;//性质
    private String channelArea;//区域
    private String channelArea1;//区域
    ...
    private String channelDecoration1;//装修情况
    ...
    private String channelBuildAge1;//建筑年代
    ...
    public ChannelHousePo2() {
        super();
        // TODO Auto-generated constructor stub
    }

    public ChannelHousePo2(String channelCode, String channelNature, String channelNature1, String channelArea,
                           String channelArea1, String channelPosition, String channelBuildName, String channelCoverArea,
                           String channelBuildArea, String channelInterior, String channelDecoration, String channelDecoration1,
                           String channelPurchasing, String channelIntroduce, String channelPrice, String channelDeposit,
                           String channelMortgage, String channelTax, String channelFloor, String channelBuildAge,
                           String channelBuildAge1, String channelHouseKeeping, String channelHouseKeepingPs, String channelRoom,
        ...
        this.channelDecoration1 = channelDecoration1;
        ...
        this.channelBuildAge1 = channelBuildAge1;
    ...
    public String toString() {
        return "ChannelHousePo2 [channelCode=" + channelCode + ", channelNature=" + channelNature + ", channelNature1="
                + channelNature1 + ", channelArea=" + channelArea + ", channelArea1=" + channelArea1
                + ", channelPosition=" + channelPosition + ", channelBuildName=" + channelBuildName
                ...
                + ", channelDecoration1=" + channelDecoration1 + ", channelPurchasing=" + channelPurchasing
                + ", channelIntroduce=" + channelIntroduce + ", channelPrice=" + channelPrice + ", channelDeposit="
                + channelDeposit + ", channelMortgage=" + channelMortgage + ", channelTax=" + channelTax
                + ", channelFloor=" + channelFloor + ", channelBuildAge=" + channelBuildAge + ", channelBuildAge1="
                + channelBuildAge1 + ", channelHouseKeeping=" + channelHouseKeeping + ", channelHouseKeepingPs="
                + channelHouseKeepingPs + ", channelRoom=" + channelRoom + ", channelHall=" + channelHall
                + ", channelKitchen=" + channelKitchen + ", channelToilet=" + channelToilet + ", order=" + order
                + ", sort=" + sort + ", channelPrice1=" + channelPrice1 + ", channelPrice2=" + channelPrice2
                + ", channelBuildArea1=" + channelBuildArea1 + ", channelBuildArea2=" + channelBuildArea2
                + ", searchMo=" + searchMo + ", userId=" + userId + "]";
    }
    ...
    public String getChannelArea1() {
        return channelArea1;
    }

    public void setChannelArea1(String channelArea1) {
        this.channelArea1 = channelArea1;
    }
    ...
    public String getChannelDecoration1() {
        return channelDecoration1;
    }

    public void setChannelDecoration1(String channelDecoration1) {
        this.channelDecoration1 = channelDecoration1;
    }
    ...
    public String getChannelBuildAge1() {
        return channelBuildAge1;
    }

    public void setChannelBuildAge1(String channelBuildAge1) {
        this.channelBuildAge1 = channelBuildAge1;
    }
