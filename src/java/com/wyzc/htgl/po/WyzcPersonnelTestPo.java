...
public class WyzcPersonnelTestPo extends BasePo {
    ...
    //2为正式员工，对应数据组只展示在正式员工栏目里面
    //3为离岗员工，对应数据只展示在离岗员工栏目里面，且对应组信息不具备注册功能
    private String contractTime; //合同签署日期

    public WyzcPersonnelTestPo() {
        super();
        // TODO Auto-generated constructor stub
    }

    public WyzcPersonnelTestPo(String userId, String userName, String userPwd, String identityCard, String wpId,
    ...
    public String toString() {
        return "WyzcPersonnelPo [userId=" + userId + ", userName=" + userName + ", userPwd=" + userPwd
                + ", identityCard=" + identityCard + ", wpId=" + wpId + ", wpIdChild=" + wpIdChild + ", wdId=" + wdId
                + ", postName=" + postName + ", userSex=" + userSex + ", practiceStart=" + practiceStart
                + ", practiceNumber=" + practiceNumber + ", practiceEnd=" + practiceEnd + ", isPostpone=" + isPostpone
                + ", postponeNumber=" + postponeNumber + ", postponeTo=" + postponeTo + ", postponeTime=" + postponeTime
                + ", startWorkTime=" + startWorkTime + ", turnOfficialTime=" + turnOfficialTime + ", dimissionTime="
                + dimissionTime + ", workAge=" + workAge + ", birDate=" + birDate + ", birYear=" + birYear
                + ", birMounth=" + birMounth + ", age=" + age + ", nation=" + nation + ", registered=" + registered
                + ", education=" + education + ", contactTel=" + contactTel + ", isOfficial=" + isOfficial
                + ", contractType=" + contractType + ", remark=" + remark + ", sign=" + sign + ", contractTime="
                + contractTime + "]";
    }
